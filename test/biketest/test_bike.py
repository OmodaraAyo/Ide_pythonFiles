...
class TestBike(unittest.TestCase):
    ...
    def test_to_turn_bike_on(self):
        self.bike.turn_on()
        self.assertTrue(self.bike.power_status())

    def test_to_turn_bike_off(self):
        self.bike.turn_off()
        self.assertFalse(self.bike.power_status())
    ...
    def test_to_accelerate_when_BikeIsOn_and_gear_is_set_to_four_bike_speed_increases_by_four(self):
        self.bike.turn_on()
        self.assertTrue(self.bike.power_status())
